...
schema_view_v1 = get_schema_view(
    openapi.Info(
        title="drf_yasg 테스트 open api",
        default_version="v1",
        description="drf_yasg 테스트용 api 다큐먼테이션",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="jwhwang@amorepacific.com"),
...
urlpatterns = [
    ...
    re_path(r'^movies', include(('movie.urls', 'movie'), namespace='movie_api')),
    # Auto DRF API docs
